...
do
    if [ $i -gt 0 ]
    then
    ckpt_file='ckpts/lb/nerfpp_CLNerf/'$data'_'$task_number'task_'$rep'_v4/epoch=19-v'$i'.ckpt'
    else
    ckpt_file='ckpts/lb/nerfpp_CLNerf/'$data'_'$task_number'task_'$rep'_v4/epoch=19.ckpt'
    fi
